    ...
    document.getElementById('send-button').addEventListener('click', () => {
        ...
        fetch('/api/disneybot', {
            ...
            .then(data => {
                ...
                chatLog.innerHTML += `<p><strong>DisneyBot:</strong> ${data.reply}</p>`;
                document.getElementById('user-input').value = '';

                // Update character image based on response
                const character = data.reply.includes('Simba') ? 'simba.jpg' :
                                  data.reply.includes('Belle') ? 'belle.jpg' :
                                  data.reply.includes('Ariel') ? 'ariel.jpg' :
                                  data.reply.includes('Tiana') ? 'tiana.jpg' :
                                  data.reply.includes('Mickey') ? 'mickey.jpg' : 'disney-logo.jpg';
                characterImage.src = character;
            })
            .catch(error => {
                chatLog.innerHTML += `<p><strong>Error:</strong> Unable to connect to DisneyBot.</p>`;
